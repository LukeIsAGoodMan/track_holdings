...
export const TRANSLATIONS = {
  ...
  analysis_sub:         { en: 'Rhino Engine — Technical, Valuation, Macro',
                          zh: 'Rhino引擎 — 技术面、估值、宏观' },
  analysis_search_ph:   { en: 'Enter symbol (e.g. MSFT, NVDA)',   zh: '输入代码（如 MSFT、NVDA）' },
  analysis_analyze:     { en: 'Analyze',                           zh: '分析' },
  analysis_loading:     { en: 'Analyzing...',                      zh: '分析中...' },
  analysis_technical:   { en: 'Technical',                         zh: '技术面' },
  analysis_valuation:   { en: 'Valuation',                         zh: '估值' },
  analysis_macro:       { en: 'Macro',                             zh: '宏观' },
  analysis_support:     { en: 'Support',                           zh: '支撑' },
  analysis_resistance:  { en: 'Resistance',                        zh: '阻力' },
  analysis_chart:       { en: 'Price Chart',                       zh: '价格走势' },
  analysis_no_chart:    { en: 'No chart data available.',          zh: '暂无图表数据。' },
  analysis_narrative:   { en: 'Analysis Report',                   zh: '分析报告' },
  analysis_val_unavailable: { en: 'Insufficient analyst estimates.', zh: '分析师预估数据不足。' },
  analysis_fair_value_band: { en: 'Fair Value Band',               zh: '合理价值区间' },
  analysis_as_of:       { en: 'As of',                             zh: '截至' },
  analysis_data_days:   { en: 'History days',                      zh: '历史天数' },
  analysis_empty:       { en: 'Search a symbol to begin.',         zh: '输入代码开始分析。' },
  analysis_empty_hint:  { en: 'Try MSFT, NVDA, AAPL, or TSLA.',   zh: '试试 MSFT、NVDA、AAPL 或 TSLA。' },
  analysis_section_overview:   { en: 'Overview',     zh: '概览' },
  analysis_section_technical:  { en: 'Technical',    zh: '技术面' },
  analysis_section_valuation:  { en: 'Valuation',    zh: '估值' },
  analysis_section_macro:      { en: 'Macro',        zh: '宏观' },
  analysis_section_playbook:   { en: 'Playbook',     zh: '策略' },
  analysis_section_confidence: { en: 'Confidence',   zh: '置信度' },
} as const
