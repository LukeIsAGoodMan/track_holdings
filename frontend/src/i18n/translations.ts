...
export const TRANSLATIONS = {
  ...
  col_spot:         { en: 'Spot',         zh: '现价' },
  col_market:       { en: 'Market',       zh: '市值' },
  col_pnl:          { en: 'P&L',          zh: '盈亏' },
  col_day_pnl:      { en: 'Day P&L',      zh: '日盈亏' },
  ...
  exp_n_more:       { en: 'more',             zh: '更多' },

  // ── Exposure tag labels ─────────────────────────────────────────────────
  tag_technology:       { en: 'Technology',            zh: '科技' },
  tag_big_tech:         { en: 'Big Tech',              zh: '大型科技' },
  tag_semiconductor:    { en: 'Semiconductor',         zh: '半导体' },
  tag_ai:               { en: 'AI',                    zh: '人工智能' },
  tag_cloud:            { en: 'Cloud',                 zh: '云计算' },
  tag_networking:       { en: 'Networking',            zh: '网络' },
  tag_social:           { en: 'Social',                zh: '社交' },
  tag_growth:           { en: 'Growth',                zh: '成长' },
  tag_value:            { en: 'Value',                 zh: '价值' },
  tag_healthcare:       { en: 'Healthcare',            zh: '医疗' },
  tag_finance:          { en: 'Finance',               zh: '金融' },
  tag_financials:       { en: 'Financials',            zh: '金融业' },
  tag_energy:           { en: 'Energy',                zh: '能源' },
  tag_consumer_discretionary: { en: 'Consumer Discretionary', zh: '可选消费' },
  tag_consumer_staples: { en: 'Consumer Staples',      zh: '必选消费' },
  tag_industrials:      { en: 'Industrials',           zh: '工业' },
  tag_materials:        { en: 'Materials',             zh: '材料' },
  tag_real_estate:      { en: 'Real Estate',           zh: '房地产' },
  tag_communication_services: { en: 'Communication Services', zh: '通信服务' },
  tag_utilities:        { en: 'Utilities',             zh: '公共事业' },
  tag_other:            { en: 'Other',                 zh: '其他' },
