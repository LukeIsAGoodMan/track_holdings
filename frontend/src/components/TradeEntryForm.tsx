          ...
          <div>
            <label className={LBL} style={LBL_COLOR}>
              <span className="flex items-center gap-1">
                {t('trade_reason_lbl')}
                <svg className="w-3.5 h-3.5 text-stone-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round"><path d="M6 9l6 6 6-6" /></svg>
              </span>
            ...
            <textarea
              ...
              className="w-full text-xs rounded-v2-md border border-stone-400 bg-stone-50/50 px-3 py-2 text-stone-800 placeholder:text-stone-500/65 focus:outline-none focus:ring-1 focus:ring-stone-400/30 focus:bg-white/95 resize-y min-h-[4rem] max-h-[12rem] ds-bg"
            />
          </div>
