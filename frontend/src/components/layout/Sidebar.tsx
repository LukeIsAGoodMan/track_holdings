 ...
 * State 2 — Expanded   (224px):  nav list with "New Trade" item + portfolio tree
 * State 3 — Trade      (420px):  full TradeEntryForm, locked until Back is pressed
 *
 * Expands via explicit toggle button only (no hover-expand).
 * Trade mode triggered by openTradeEntry() → forces 420 px.
...
export default function Sidebar() {
  ...
  // Three-state widths
  const sidebarWidth = isTradeMode ? 420 : isExpanded ? 224 : 64
  ...
  return (
    <aside
      className="shrink-0 flex flex-col bg-white border-r border-slate-200
                 sticky top-14 h-[calc(100vh-3.5rem)] overflow-hidden font-sans
    ...
    >
      {isTradeMode ? (
        ...
        /* ════════════════════════════════════════════════════════════════════
         * STATE 3 — PINNED TRADE ENTRY  (420px)
         ...
         * New Trade action + Portfolio tree + collapse button
         * ════════════════════════════════════════════════════════════════════ */
        <div className="flex flex-col h-full min-h-0">
          ...
          {/* Thin rule */}
          <div className="mx-3 h-px bg-slate-100 mb-1.5 shrink-0" />
